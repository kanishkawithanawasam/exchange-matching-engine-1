...
/**
 * Deterministic contract fixture; test sources never depend on benchmark sources.
 */
public final class TestWorkloads {
    private TestWorkloads() {
    }

    public static Command[] cycle(int count) {
